...
import {
  ...
  TransactionHash as TransactionHash$1,
  Errors,
  ETransactionVersion2 as ETransactionVersion2$1,
  ...
  TypedDataRevision,
  BlockWithTxReceipts,
  InvokedTransaction as InvokedTransaction$2,
  DeclaredTransaction as DeclaredTransaction$2,
  DeployedAccountTransaction as DeployedAccountTransaction$1,
  L1Message as L1Message$1,
  EventFilter as EventFilter$1,
...
declare namespace index$5 {
  export type {
    Error$1 as Error,
    index$5_ErrorResponseBody as ErrorResponseBody,
    index$5_RequestBody as RequestBody,
    index$5_ResponseBody as ResponseBody,
    index$5_SuccessResponseBody as SuccessResponseBody,
  };
}
...
type BLOCK_HASH$2 = FELT$1;
type TXN_HASH$2 = FELT$1;
...
type TXN_RECEIPT =
  | INVOKE_TXN_RECEIPT$1
  | L1_HANDLER_TXN_RECEIPT$1
  | DECLARE_TXN_RECEIPT$1
  | DEPLOY_TXN_RECEIPT
  | DEPLOY_ACCOUNT_TXN_RECEIPT$1;
type PENDING_TXN_RECEIPT =
  | PENDING_INVOKE_TXN_RECEIPT$1
  | PENDING_L1_HANDLER_TXN_RECEIPT$1
  | PENDING_DECLARE_TXN_RECEIPT$1
  | PENDING_DEPLOY_ACCOUNT_TXN_RECEIPT$1;
type MSG_TO_L1 = {
  from_address: FELT$1;
  to_address: FELT$1;
  payload: FELT$1[];
...
declare namespace components {
  export type {
    ...
    DECLARE_TXN_RECEIPT$1 as DECLARE_TXN_RECEIPT,
    ...
    DEPLOY_ACCOUNT_TXN_RECEIPT$1 as DEPLOY_ACCOUNT_TXN_RECEIPT,
    ...
    INVOKE_TXN_RECEIPT$1 as INVOKE_TXN_RECEIPT,
    ...
    L1_HANDLER_TXN_RECEIPT$1 as L1_HANDLER_TXN_RECEIPT,
    ...
    PENDING_DECLARE_TXN_RECEIPT$1 as PENDING_DECLARE_TXN_RECEIPT,
    PENDING_DEPLOY_ACCOUNT_TXN_RECEIPT$1 as PENDING_DEPLOY_ACCOUNT_TXN_RECEIPT,
    PENDING_INVOKE_TXN_RECEIPT$1 as PENDING_INVOKE_TXN_RECEIPT,
    PENDING_L1_HANDLER_TXN_RECEIPT$1 as PENDING_L1_HANDLER_TXN_RECEIPT,
    PENDING_STATE_UPDATE$1 as PENDING_STATE_UPDATE,
    components_PENDING_TXN_RECEIPT as PENDING_TXN_RECEIPT,
    PRICE_UNIT$1 as PRICE_UNIT,
    ...
    RESOURCE_PRICE$1 as RESOURCE_PRICE,
    ...
    STATE_UPDATE$1 as STATE_UPDATE,
...
declare namespace index$4 {
  export {
    type index$4_ABI as ABI,
    type index$4_BaseTransaction as BaseTransaction,
    type index$4_BlockHash as BlockHash,
    type index$4_BlockHashAndNumber as BlockHashAndNumber,
    type index$4_BlockTransactionsTraces as BlockTransactionsTraces,
    type BlockWithTxHashes$1 as BlockWithTxHashes,
    type index$4_BlockWithTxs as BlockWithTxs,
    type index$4_ChainId as ChainId,
    type index$4_ContractAddress as ContractAddress,
    type ContractClass$1 as ContractClass,
    type DeclaredTransaction$1 as DeclaredTransaction,
    type index$4_DeployedAccountTransaction as DeployedAccountTransaction,
    type index$4_DeprecatedDeclaredClasses as DeprecatedDeclaredClasses,
    type index$4_EBlockTag as EBlockTag,
    type index$4_EDAMode as EDAMode,
    type index$4_EDataAvailabilityMode as EDataAvailabilityMode,
    type index$4_ESimulationFlag as ESimulationFlag,
    type index$4_ETransactionExecutionStatus as ETransactionExecutionStatus,
    type index$4_ETransactionFinalityStatus as ETransactionFinalityStatus,
    type index$4_ETransactionStatus as ETransactionStatus,
    type index$4_ETransactionType as ETransactionType,
    type index$4_ETransactionVersion as ETransactionVersion,
    type index$4_ETransactionVersion2 as ETransactionVersion2,
    type index$4_ETransactionVersion3 as ETransactionVersion3,
    type index$4_EmittedEvent as EmittedEvent,
    errors as Errors,
    type index$4_Event as Event,
    type index$4_EventFilter as EventFilter,
    type index$4_Events as Events,
    type FeeEstimate$1 as FeeEstimate,
    type index$4_FeePayment as FeePayment,
    type index$4_Felt as Felt,
    type InvokedTransaction$1 as InvokedTransaction,
    type index$4_L1Message as L1Message,
    type index$4_Methods as Methods,
    type Nonce$1 as Nonce,
    type index$4_NonceUpdates as NonceUpdates,
    type index$4_PendingReceipt as PendingReceipt,
    type index$4_PriceUnit as PriceUnit,
    type index$4_Receipt as Receipt,
    type index$4_ReplacedClasses as ReplacedClasses,
    type ResourceBounds$1 as ResourceBounds,
    components as SPEC,
    type SimulateTransaction$1 as SimulateTransaction,
    type SimulateTransactionResponse$1 as SimulateTransactionResponse,
    type SimulationFlags$1 as SimulationFlags,
    type StateUpdate$1 as StateUpdate,
    type index$4_StorageDiffs as StorageDiffs,
    type index$4_Syncing as Syncing,
    type index$4_Transaction as Transaction,
    type index$4_TransactionHash as TransactionHash,
    type TransactionReceipt$1 as TransactionReceipt,
    type TransactionStatus$1 as TransactionStatus,
    type index$4_TransactionTrace as TransactionTrace,
    type TransactionWithHash$1 as TransactionWithHash,
  };
}
...
declare enum RosettaNetworkName {
  MAIN = 'MAIN',
}
...
declare const RPC_NODES: {
  readonly SN_MAIN: readonly [
    'https://starknet-mainnet.public.blastapi.io/rpc/v0_7',
    'https://free-rpc.nethermind.io/mainnet-juno/v0_7',
  ];
  readonly SN_SEPOLIA: readonly [
    'https://starknet-sepolia.public.blastapi.io/rpc/v0_7',
    'https://free-rpc.nethermind.io/sepolia-juno/v0_7',
  ];
};
declare const ROSETTANET_RPC_NODES: {
  MAIN: string[];
};
...
declare const constants_ROSETTANET_RPC_NODES: typeof ROSETTANET_RPC_NODES;
declare const constants_RPC_DEFAULT_VERSION: typeof RPC_DEFAULT_VERSION;
declare const constants_RPC_NODES: typeof RPC_NODES;
type constants_RosettaNetworkName = RosettaNetworkName;
declare const constants_RosettaNetworkName: typeof RosettaNetworkName;
type constants_RosettanetChainId = RosettanetChainId;
declare const constants_RosettanetChainId: typeof RosettanetChainId;
...
declare namespace constants {
  export {
    ...
    constants_FeeMarginPercentage as FeeMarginPercentage,
    ...
    constants_ROSETTANET_RPC_NODES as ROSETTANET_RPC_NODES,
    constants_RPC_DEFAULT_VERSION as RPC_DEFAULT_VERSION,
    constants_RPC_NODES as RPC_NODES,
    constants_RosettaNetworkName as RosettaNetworkName,
    constants_RosettanetChainId as RosettanetChainId,
    ...
    ETransactionVersion$1 as TRANSACTION_VERSION,
    ...
    : T2 extends Array<any>
      ...
      : T1 extends object
        ...
        : T2 extends object
          ...
          : T1 | T2
>;
type BLOCK_HASH$1 = Merge<BLOCK_HASH$2, RPCSPEC07.SPEC.BLOCK_HASH>;
type BLOCK_NUMBER$1 = Merge<BLOCK_NUMBER$2, RPCSPEC07.SPEC.BLOCK_NUMBER>;
type FELT = Merge<FELT$1, RPCSPEC07.SPEC.FELT>;
type TXN_HASH$1 = Merge<TXN_HASH$2, RPCSPEC07.SPEC.TXN_HASH>;
...
declare const ETH_ADDRESS$1 = 'core::starknet::eth_address::EthAddress';
...
type V2DeployAccountSignerDetails = Required<DeployAccountContractPayload> &
...
declare namespace index$2 {
  export {
    type index$2_Abi as Abi,
    type index$2_AbiEntry as AbiEntry,
    type index$2_AbiEnum as AbiEnum,
    type index$2_AbiEnums as AbiEnums,
    type index$2_AbiEvent as AbiEvent,
    type index$2_AbiEvents as AbiEvents,
    type index$2_AbiInterfaces as AbiInterfaces,
    type index$2_AbiStruct as AbiStruct,
    type index$2_AbiStructs as AbiStructs,
    type index$2_AccountInvocationItem as AccountInvocationItem,
    type index$2_AccountInvocations as AccountInvocations,
    type index$2_AccountInvocationsFactoryDetails as AccountInvocationsFactoryDetails,
    type index$2_AllowArray as AllowArray,
    type index$2_Args as Args,
    type index$2_ArgsOrCalldata as ArgsOrCalldata,
    type index$2_ArgsOrCalldataWithOptions as ArgsOrCalldataWithOptions,
    type index$2_ArraySignatureType as ArraySignatureType,
    type index$2_AsyncContractFunction as AsyncContractFunction,
    type index$2_BigNumberish as BigNumberish,
    type Block$1 as Block,
    type index$2_BlockIdentifier as BlockIdentifier,
    type index$2_BlockNumber as BlockNumber,
    type index$2_BlockStatus as BlockStatus,
    type index$2_BlockTag as BlockTag,
    type index$2_BlockWithTxHashes as BlockWithTxHashes,
    type index$2_Builtins as Builtins,
    type index$2_ByteArray as ByteArray,
    type index$2_ByteCode as ByteCode,
    type index$2_CairoAssembly as CairoAssembly,
    type index$2_CairoContract as CairoContract,
    type index$2_CairoEnum as CairoEnum,
    type index$2_CairoEvent as CairoEvent,
    type index$2_CairoEventDefinition as CairoEventDefinition,
    type index$2_CairoEventVariant as CairoEventVariant,
    type index$2_CairoVersion as CairoVersion,
    type index$2_Call as Call,
    type index$2_CallContractResponse as CallContractResponse,
    type index$2_CallDetails as CallDetails,
    type index$2_CallOptions as CallOptions,
    type index$2_CallStruct as CallStruct,
    type index$2_Calldata as Calldata,
    type index$2_CompiledContract as CompiledContract,
    type index$2_CompiledSierra as CompiledSierra,
    type index$2_CompiledSierraCasm as CompiledSierraCasm,
    type index$2_CompilerVersion as CompilerVersion,
    type index$2_CompleteDeclareContractPayload as CompleteDeclareContractPayload,
    type index$2_CompressedProgram as CompressedProgram,
    type index$2_ContractClass as ContractClass,
    type index$2_ContractClassIdentifier as ContractClassIdentifier,
    type index$2_ContractClassPayload as ContractClassPayload,
    type index$2_ContractClassResponse as ContractClassResponse,
    type index$2_ContractEntryPointFields as ContractEntryPointFields,
    type index$2_ContractFunction as ContractFunction,
    type index$2_ContractOptions as ContractOptions,
    type index$2_ContractVersion as ContractVersion,
    type index$2_DeclareAndDeployContractPayload as DeclareAndDeployContractPayload,
    type index$2_DeclareContractPayload as DeclareContractPayload,
    ...
    type index$2_DeclareDeployUDCResponse as DeclareDeployUDCResponse,
    type index$2_DeclareSignerDetails as DeclareSignerDetails,
    type index$2_DeclareTransactionReceiptResponse as DeclareTransactionReceiptResponse,
    type index$2_DeployAccountContractPayload as DeployAccountContractPayload,
    type index$2_DeployAccountContractTransaction as DeployAccountContractTransaction,
    type index$2_DeployAccountSignerDetails as DeployAccountSignerDetails,
    type index$2_DeployAccountTransactionReceiptResponse as DeployAccountTransactionReceiptResponse,
    type index$2_DeployContractResponse as DeployContractResponse,
    type index$2_DeployContractUDCResponse as DeployContractUDCResponse,
    type index$2_DeployTransactionReceiptResponse as DeployTransactionReceiptResponse,
    type index$2_Details as Details,
    ETH_ADDRESS$1 as ETH_ADDRESS,
    type index$2_EntryPointType as EntryPointType,
    type index$2_EntryPointsByType as EntryPointsByType,
    type index$2_EstimateFee as EstimateFee,
    type index$2_EstimateFeeAction as EstimateFeeAction,
    type index$2_EstimateFeeBulk as EstimateFeeBulk,
    type index$2_EstimateFeeDetails as EstimateFeeDetails,
    type index$2_EstimateFeeResponse as EstimateFeeResponse,
    type index$2_EstimateFeeResponseBulk as EstimateFeeResponseBulk,
    type index$2_EventEntry as EventEntry,
    type index$2_FeeEstimate as FeeEstimate,
    type index$2_FunctionAbi as FunctionAbi,
    type index$2_GetBlockResponse as GetBlockResponse,
    type index$2_GetTransactionResponse as GetTransactionResponse,
    type index$2_GetTxReceiptResponseWithoutHelper as GetTxReceiptResponseWithoutHelper,
    type index$2_HexCalldata as HexCalldata,
    type index$2_InterfaceAbi as InterfaceAbi,
    type index$2_Invocation as Invocation,
    type index$2_Invocations as Invocations,
    type index$2_InvocationsDetails as InvocationsDetails,
    type index$2_InvocationsDetailsWithNonce as InvocationsDetailsWithNonce,
    type index$2_InvocationsSignerDetails as InvocationsSignerDetails,
    type index$2_InvokeFunctionResponse as InvokeFunctionResponse,
    type index$2_InvokeOptions as InvokeOptions,
    type index$2_InvokeTransactionReceiptResponse as InvokeTransactionReceiptResponse,
    type index$2_L1HandlerTransactionReceiptResponse as L1HandlerTransactionReceiptResponse,
    type index$2_LedgerPathCalculation as LedgerPathCalculation,
    type index$2_LegacyCompiledContract as LegacyCompiledContract,
    type index$2_LegacyContractClass as LegacyContractClass,
    type index$2_LegacyEvent as LegacyEvent,
    type index$2_Literal as Literal,
    type index$2_MessageToL1 as MessageToL1,
    type index$2_MultiDeployContractResponse as MultiDeployContractResponse,
    type index$2_MultiType as MultiType,
    index$2_NON_ZERO_PREFIX as NON_ZERO_PREFIX,
    type index$2_Nonce as Nonce,
    type index$2_OptionalPayload as OptionalPayload,
    type index$2_OutsideCall as OutsideCall,
    type index$2_OutsideExecution as OutsideExecution,
    type index$2_OutsideExecutionOptions as OutsideExecutionOptions,
    index$2_OutsideExecutionTypesV1 as OutsideExecutionTypesV1,
    index$2_OutsideExecutionTypesV2 as OutsideExecutionTypesV2,
    index$2_OutsideExecutionVersion as OutsideExecutionVersion,
    type index$2_OutsideTransaction as OutsideTransaction,
    type index$2_ParsedEvent as ParsedEvent,
    type index$2_ParsedEvents as ParsedEvents,
    type index$2_ParsedStruct as ParsedStruct,
    type index$2_PendingBlock as PendingBlock,
    type index$2_PendingStateUpdate as PendingStateUpdate,
    type index$2_Program as Program,
    type index$2_ProviderOptions as ProviderOptions,
    type index$2_PythonicHints as PythonicHints,
    index$3 as RPC,
    type index$2_RPC_ERROR as RPC_ERROR,
    type index$2_RPC_ERROR_SET as RPC_ERROR_SET,
    type index$2_RawArgs as RawArgs,
    type index$2_RawArgsArray as RawArgsArray,
    type index$2_RawArgsObject as RawArgsObject,
    type index$2_RawCalldata as RawCalldata,
    type index$2_RejectedTransactionReceiptResponse as RejectedTransactionReceiptResponse,
    type index$2_Result as Result,
    type index$2_RevertedTransactionReceiptResponse as RevertedTransactionReceiptResponse,
    type index$2_RpcProviderOptions as RpcProviderOptions,
    type index$2_SIMULATION_FLAG as SIMULATION_FLAG,
    type index$2_SierraContractClass as SierraContractClass,
    type index$2_SierraContractEntryPointFields as SierraContractEntryPointFields,
    type index$2_SierraEntryPointsByType as SierraEntryPointsByType,
    type index$2_SierraProgramDebugInfo as SierraProgramDebugInfo,
    type index$2_Signature as Signature,
    type index$2_SimulateTransactionDetails as SimulateTransactionDetails,
    type index$2_SimulateTransactionResponse as SimulateTransactionResponse,
    type index$2_SimulatedTransaction as SimulatedTransaction,
    type index$2_SimulationFlags as SimulationFlags,
    type index$2_StarkProfile as StarkProfile,
    ...
    type index$2_StateUpdate as StateUpdate,
    type index$2_StateUpdateResponse as StateUpdateResponse,
    type index$2_Storage as Storage,
    type index$2_SuccessfulTransactionReceiptResponse as SuccessfulTransactionReceiptResponse,
    type index$2_TransactionExecutionStatus as TransactionExecutionStatus,
    type index$2_TransactionFinalityStatus as TransactionFinalityStatus,
    type index$2_TransactionReceipt as TransactionReceipt,
    type index$2_TransactionReceiptCallbacks as TransactionReceiptCallbacks,
    type index$2_TransactionReceiptCallbacksDefault as TransactionReceiptCallbacksDefault,
    type index$2_TransactionReceiptCallbacksDefined as TransactionReceiptCallbacksDefined,
    type index$2_TransactionReceiptStatus as TransactionReceiptStatus,
    type index$2_TransactionReceiptUtilityInterface as TransactionReceiptUtilityInterface,
    type index$2_TransactionReceiptValue as TransactionReceiptValue,
    type index$2_TransactionStatus as TransactionStatus,
    type index$2_TransactionStatusReceiptSets as TransactionStatusReceiptSets,
    type index$2_TransactionType as TransactionType,
    type index$2_Tupled as Tupled,
    index$2_TypedData as TypedData,
    index$2_TypedDataRevision as TypedDataRevision,
    type index$2_Uint as Uint,
    type index$2_Uint256 as Uint256,
    type index$2_Uint512 as Uint512,
    type index$2_UniversalDeployerContractPayload as UniversalDeployerContractPayload,
    type index$2_UniversalDetails as UniversalDetails,
    type index$2_UniversalSuggestedFee as UniversalSuggestedFee,
    type index$2_V2DeclareSignerDetails as V2DeclareSignerDetails,
    type index$2_V2DeployAccountSignerDetails as V2DeployAccountSignerDetails,
    type index$2_V2InvocationsSignerDetails as V2InvocationsSignerDetails,
    type index$2_V3DeclareSignerDetails as V3DeclareSignerDetails,
    type index$2_V3DeployAccountSignerDetails as V3DeployAccountSignerDetails,
    type index$2_V3InvocationsSignerDetails as V3InvocationsSignerDetails,
    type index$2_V3TransactionDetails as V3TransactionDetails,
    type index$2_ValidateType as ValidateType,
    type index$2_WeierstrassSignatureType as WeierstrassSignatureType,
    type index$2_getContractVersionOptions as getContractVersionOptions,
    type index$2_getEstimateFeeBulkOptions as getEstimateFeeBulkOptions,
    type index$2_getSimulateTransactionOptions as getSimulateTransactionOptions,
    type index$2_waitForTransactionOptions as waitForTransactionOptions,
  };
}
...
declare class RpcChannel$1 {
  ...
  protected fetchEndpoint<T extends keyof Methods>(
    method: T,
  ...
  ): Promise<SimulateTransactionResponse$1>;
  waitForTransaction(
    txHash: BigNumberish,
  ...
  getClassAt(
    contractAddress: BigNumberish,
    blockIdentifier?: BlockIdentifier
  ): Promise<ContractClass$1>;
  getEstimateFee(
    invocations: AccountInvocations,
    { blockIdentifier, skipValidate }: getEstimateFeeBulkOptions
  ): Promise<FEE_ESTIMATE[]>;
  invoke(
    functionInvocation: Invocation,
    details: InvocationsDetailsWithNonce
  ): Promise<InvokedTransaction$1>;
  declare(
    { contract, signature, senderAddress, compiledClassHash }: DeclareContractTransaction,
    details: InvocationsDetailsWithNonce
  ): Promise<TXN_RECEIPT | DeclaredTransaction$1>;
  deployAccount(
...
declare class RpcChannel {
  ...
  fetch(method: string, params?: object, id?: string | number): Promise<Response>;
  protected errorHandler(method: string, params: any, rpcError?: Error$1, otherError?: any): void;
  protected fetchEndpoint<T extends keyof RPCSPEC07.Methods>(
    method: T,
    params?: RPCSPEC07.Methods[T]['params']
  ): Promise<RPCSPEC07.Methods[T]['result']>;
  getChainId(): Promise<StarknetChainId>;
  getSpecVersion(): Promise<string>;
  getNonceForAddress(
    contractAddress: BigNumberish,
  ...
  getBlockTransactionsTraces(
    blockIdentifier?: BlockIdentifier
  ): Promise<RPCSPEC07.BlockTransactionsTraces>;
  getBlockTransactionCount(blockIdentifier?: BlockIdentifier): Promise<number>;
  getTransactionByHash(txHash: BigNumberish): Promise<RPCSPEC07.TransactionWithHash>;
  getTransactionByBlockIdAndIndex(
    blockIdentifier: BlockIdentifier,
    index: number
  ): Promise<RPCSPEC07.TransactionWithHash>;
  getTransactionReceipt(
    txHash: BigNumberish
  ): Promise<RPCSPEC07.API.SPEC.TXN_RECEIPT_WITH_BLOCK_INFO>;
  ...
  simulateTransaction(
    invocations: AccountInvocations,
    simulateTransactionOptions?: getSimulateTransactionOptions
  ): Promise<RPCSPEC07.SimulateTransactionResponse>;
  waitForTransaction(
    txHash: BigNumberish,
    options?: waitForTransactionOptions
  ): Promise<RPCSPEC07.API.SPEC.TXN_RECEIPT>;
  getStorageAt(
    contractAddress: BigNumberish,
    key: BigNumberish,
    blockIdentifier?: BlockIdentifier
  ...
  getClass(
    classHash: BigNumberish,
    blockIdentifier?: BlockIdentifier
  ): Promise<RPCSPEC07.ContractClass>;
  getClassAt(
    contractAddress: BigNumberish,
    blockIdentifier?: BlockIdentifier
  ): Promise<RPCSPEC07.ContractClass>;
  getEstimateFee(
    invocations: AccountInvocations,
    { blockIdentifier, skipValidate }: getEstimateFeeBulkOptions
  ): Promise<RPCSPEC07.API.SPEC.FEE_ESTIMATE[]>;
  invoke(
    functionInvocation: Invocation,
    details: InvocationsDetailsWithNonce
  ): Promise<RPCSPEC07.InvokedTransaction>;
  declare(
    { contract, signature, senderAddress, compiledClassHash }: DeclareContractTransaction,
    details: InvocationsDetailsWithNonce
  ): Promise<RPCSPEC07.DeclaredTransaction | RPCSPEC07.API.SPEC.TXN_RECEIPT>;
  deployAccount(
    { classHash, constructorCalldata, addressSalt, signature }: DeployAccountContractTransaction,
    details: InvocationsDetailsWithNonce
  ): Promise<RPCSPEC07.API.SPEC.TXN_RECEIPT | RPCSPEC07.DeployedAccountTransaction>;
  callContract(call: Call, blockIdentifier?: BlockIdentifier): Promise<string[]>;
  /**
   * NEW: Estimate the fee for a message from L1
   * @param message Message From L1
...
declare class RPCResponseParser
  implements
    Omit<
      ResponseParser,
...
declare class RpcProvider$1 implements ProviderInterface {
  ...
  invokeFunction(
    functionInvocation: Invocation,
    details: InvocationsDetailsWithNonce
  ): Promise<InvokedTransaction$2>;
  declareContract(
    transaction: DeclareContractTransaction,
    details: InvocationsDetailsWithNonce
  ): Promise<DeclaredTransaction$2>;
  deployAccountContract(
    transaction: DeployAccountContractTransaction,
    details: InvocationsDetailsWithNonce
  ): Promise<DeployedAccountTransaction$1>;
  callContract(call: Call, blockIdentifier?: BlockIdentifier): Promise<string[]>;
  /**
   * NEW: Estimate the fee for a message from L1
   * @param message Message From L1
...
declare const RpcProvider_base: ts_mixer_dist_types_types.Class<
  any[],
  RpcProvider$1 & StarknetId,
  typeof RpcProvider$1 & typeof StarknetId
>;
...
declare class Account extends RpcProvider implements AccountInterface {
  ...
  constructor(
    ...
    cairoVersion?: CairoVersion,
    transactionVersion?: typeof ETransactionVersion$1.V2 | typeof ETransactionVersion$1.V3
  );
  protected getPreferredVersion(
    type12: ETransactionVersion$1,
    type3: ETransactionVersion$1
  ): ETransactionVersion$1;
  ...
  protected getUniversalSuggestedFee(
    version: ETransactionVersion$1,
  ...
  getStarkName(
    address?: BigNumberish, // default to the wallet address
    StarknetIdContract?: string
  ): Promise<string>;
}
...
declare function requestAccounts$1(ewo: EthereumWindowObject): Promise<string[]>;
declare function watchAsset$1(
  ewo: EthereumWindowObject,
  asset: WatchAssetParameters
): Promise<boolean>;
declare function requestChainId$1(ewo: EthereumWindowObject): Promise<string>;
declare function sendTransaction(ewo: EthereumWindowObject, tx: TX_REQUEST): Promise<string>;
declare function switchRosettanetChain(
  ewo: EthereumWindowObject,
  chainId: ChainId$1
): Promise<string>;
declare function getPermissions$1(ewo: EthereumWindowObject): Promise<Permission[]>;
declare function personalSign(
  ewo: EthereumWindowObject,
  message: string,
  address: string
): Promise<string>;
...
declare function getBalance(
  ewo: EthereumWindowObject,
  address: string,
  block?: BLOCK_HASH | BLOCK_NUMBER | BLOCK_TAG
): Promise<string>;
declare function getBlockByHash(
  ewo: EthereumWindowObject,
  blockHash: BLOCK_HASH,
  hydratedTx?: boolean
): Promise<string>;
declare function getBlockByNumber(
  ewo: EthereumWindowObject,
  blockNumber: BLOCK_NUMBER | BLOCK_TAG,
  hydratedTx?: boolean
): Promise<string>;
declare function getBlockTransactionCountByHash(
  ewo: EthereumWindowObject,
  blockHash: BLOCK_HASH
): Promise<string>;
declare function getBlockTransactionCountByNumber(
  ewo: EthereumWindowObject,
  blockNumber: BLOCK_NUMBER | BLOCK_TAG
): Promise<string>;
...
declare function getTransactionHashByBlockHashAndIndex(
  ewo: EthereumWindowObject,
  blockHash: BLOCK_HASH,
  index: string
): Promise<string>;
declare function getTransactionHashByBlockNumberAndIndex(
  ewo: EthereumWindowObject,
  blockNumber: BLOCK_NUMBER | BLOCK_TAG,
  index: string
): Promise<string>;
declare function getTransactionByHash(ewo: EthereumWindowObject, txHash: TXN_HASH): Promise<string>;
declare function getTransactionCount(
  ewo: EthereumWindowObject,
  address: string,
  block?: BLOCK_HASH | BLOCK_NUMBER | BLOCK_TAG
): Promise<string>;
...
declare namespace rosettanetConnect {
  export {
    type rosettanetConnect_EthereumWindowObject as EthereumWindowObject,
    rosettanetConnect_accounts as accounts,
    rosettanetConnect_call as call,
    rosettanetConnect_clientVersion as clientVersion,
    rosettanetConnect_estimateGas as estimateGas,
    rosettanetConnect_gasPrice as gasPrice,
    rosettanetConnect_getBalance as getBalance,
    rosettanetConnect_getBlockByHash as getBlockByHash,
    rosettanetConnect_getBlockByNumber as getBlockByNumber,
    rosettanetConnect_getBlockNumber as getBlockNumber,
    rosettanetConnect_getBlockTransactionCountByHash as getBlockTransactionCountByHash,
    rosettanetConnect_getBlockTransactionCountByNumber as getBlockTransactionCountByNumber,
    rosettanetConnect_getCode as getCode,
    getPermissions$1 as getPermissions,
    rosettanetConnect_getTransactionByHash as getTransactionByHash,
    rosettanetConnect_getTransactionCount as getTransactionCount,
    rosettanetConnect_getTransactionHashByBlockHashAndIndex as getTransactionHashByBlockHashAndIndex,
    rosettanetConnect_getTransactionHashByBlockNumberAndIndex as getTransactionHashByBlockNumberAndIndex,
    rosettanetConnect_getTransactionReceipt as getTransactionReceipt,
    rosettanetConnect_personalSign as personalSign,
    requestAccounts$1 as requestAccounts,
    requestChainId$1 as requestChainId,
    rosettanetConnect_sendTransaction as sendTransaction,
    signMessage$1 as signMessage,
    rosettanetConnect_switchRosettanetChain as switchRosettanetChain,
    rosettanetConnect_syncing as syncing,
...
declare class RosettanetAccount extends Account implements AccountInterface {
  ...
  getTransactionHashByBlockNumberAndIndexRosettanet(
    blockNumber: BLOCK_NUMBER | BLOCK_TAG,
    index: string
  ): Promise<string>;
...
declare class Contract implements ContractInterface {
  ...
  invoke(
    method: string,
    args?: ArgsOrCalldata,
    { parseRequest, maxFee, nonce, signature }?: InvokeOptions
  ): Promise<InvokeFunctionResponse>;
...
declare namespace index$1 {
  export {
    ...
    index$1_calculateL2MessageTxHash as calculateL2MessageTxHash,
    index$1_computeCompiledClassHash as computeCompiledClassHash,
    index$1_computeContractClassHash as computeContractClassHash,
    index$1_computeHashOnElements as computeHashOnElements,
    index$1_computeHintedClassHash as computeHintedClassHash,
    ...
    index$1_getL2MessageHash as getL2MessageHash,
    index$1_getSelector as getSelector,
    index$1_getSelectorFromName as getSelectorFromName,
    index$1_hashByteCodeSegments as hashByteCodeSegments,
    index$1_keccakBn as keccakBn,
    index$1_poseidon as poseidon,
    index$1_solidityUint256PackedKeccak256 as solidityUint256PackedKeccak256,
...
declare namespace num {
  export {
    type num_BigNumberish as BigNumberish,
...
declare namespace transaction {
  export {
    transaction_buildUDCCall as buildUDCCall,
 ...
 * ```
 */
declare function estimateFeeToBounds(
  estimate: FeeEstimate | 0n,
  amountOverhead?: number,
  priceOverhead?: number
): ResourceBounds$2;
/**
...
declare namespace stark {
  export {
    ...
    stark_getFullPublicKey as getFullPublicKey,
 ...
 * ```
 */
declare function isPendingStateUpdate(
 ...
 */
declare function parseUDCEvent(
...
declare namespace index {
  export {
    ...
    index_parseUDCEvent as parseUDCEvent,
  };
}
...
declare namespace connect {
  export {
    connect_addDeclareTransaction as addDeclareTransaction,
    connect_addInvokeTransaction as addInvokeTransaction,
    connect_addStarknetChain as addStarknetChain,
    connect_deploymentData as deploymentData,
    connect_getPermissions as getPermissions,
    connect_onAccountChange as onAccountChange,
    connect_onNetworkChanged as onNetworkChanged,
    connect_requestAccounts as requestAccounts,
    connect_requestChainId as requestChainId,
    connect_signMessage as signMessage,
    connect_supportedSpecs as supportedSpecs,
...
export {
  ...
  parseCalldataField,
  provider,
  rosettanetConnect as rosettanetWallet,
  selector,
  shortString,
  splitArgsAndOptions,
  src5,
